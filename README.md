...
> ACCESS-CM2 ocean-advection experiment: see
> [README_CM2_ADVECTION.md](README_CM2_ADVECTION.md). Run the complete
> preparation and model workflow with `./submit_all.sh`.
